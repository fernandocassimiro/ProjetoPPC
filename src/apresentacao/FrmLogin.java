...
public class FrmLogin extends javax.swing.JFrame {
    ...
    public void Logar(){
        ...
        try {
            ...
            if (rs.next()){
                FrmPrincipal fmr;
                fmr = new FrmPrincipal();
                fmr.setVisible(true);
                dispose();
                        }
            else {
                    JOptionPane.showMessageDialog (null, "Usuários e Senhas inválidos!");
                    }
        }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Sistema de Gestão PPC");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
    ...
    private void setLocalionRetativeTo(Object object) {
